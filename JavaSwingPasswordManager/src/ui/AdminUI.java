...
public class AdminUI {
	...
	private void initialize() {
		...
		nbreCompteEnregistrerLbl.setBounds(450, 86, 183, 17);
		...
		chiffreNbreCompteEnregistrerLbl.setBounds(519, 107, 44, 22);
		...
		scrollBar.setBounds(764, 125, 16, 301);
		...
		separator_8.setBounds(0, 177, 752, 12);
